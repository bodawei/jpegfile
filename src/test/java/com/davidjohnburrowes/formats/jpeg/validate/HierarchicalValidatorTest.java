...
import com.davidjohnburrowes.format.jpeg.validate.HierarchicalValidator;
...
public class HierarchicalValidatorTest {

	private TestUtils utils;
	private HierarchicalValidator validator;

	@Before
	public void setUp() {
		utils = new TestUtils();
		validator = new HierarchicalValidator();
	}

	@Test
	public void SOI_DHP_SOF_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
	...
	@Test
	public void SOI_T_DHP_SOF_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
	...
	@Test
	public void SOI_T_DHP_T_SOF_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new DhpSegment());
	...
	@Test
	public void SOI_Ts_DHP_Ts_SOF_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new ComSegment());
	...
	@Test
	public void SOI_Ts_DHP_Ts_SOF_T_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new ComSegment());
	...
	@Test
	public void SOI_Ts_DHP_Ts_SOF_Ts_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new ComSegment());
	...
	@Test
	public void SOI_T_DHP_T_SOF_T_SOS_E_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new ComSegment());
	...
	@Test
	public void SOI_Ts_DHP_Ts_SOF_Ts_SOS_E_T_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new ComSegment());
	...
	@Test
	public void SOI_Ts_DHP_Ts_SOF_Ts_SOS_E_RST_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new ComSegment());
	...
	@Test
	public void SOI_Ts_DHP_Ts_SOF_Ts_SOS_E_RST_E_RST_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new AppNSegment((AppNSegment.FIRST_MARKERID)));
	...
	@Test
	public void SOI_Ts_DHP_Ts_SOF_Ts_SOS_E_RST_E_DNL_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new AppNSegment((AppNSegment.FIRST_MARKERID)));
	...
	@Test
	public void SOI_Ts_DHP_Ts_SOF_Ts_SOS_E_RST_E_DNL_Ts_SOS_E_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DqtSegment());
		elements.add(new AppNSegment((AppNSegment.FIRST_MARKERID)));
	...
	@Test
	public void SOI_DHP_Frame_Frame_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
	...
	@Test
	public void SOI_DHP_Frame_COM_Frame_EOI_noProblems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
	...
	@Test
	public void SOI_DHP_SOF_EOI_Problems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
	...
	@Test
	public void SOI_DHP_SOF_SOS_EOI_Problems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
	...
	@Test
	public void SOI_DHP_SOF_SOS_E_DNL_EOI_Problems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
	...
	@Test
	public void SOI_DHP_SOF_SOS_E_SOS_DNL_E_EOI_Problems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
	...
	@Test
	public void SOI_DHP_SOF_SOS_RST_E_EOI_Problems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
	...
	@Test
	public void SOI_DHP_SOF_SOS_E_RST_EOI_Problems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
	...
	@Test
	public void SOI_DHP_Frame_DHP_Frame_EOI_Problems() {
		List<DataItem> elements = new ArrayList<DataItem>();
		elements.add(new SoiMarker());
		elements.add(new DhpSegment());
		elements.add(new SofSegment(SofSegment.FIRST1_MARKERID));
		...
		assertEquals(5, validator.validate(elements).size());
	}
